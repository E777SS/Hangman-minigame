...
# функция загадываемого слова
def get_word():
    wordlist = ['год', 'человек', 'время', 'дело', 'жизнь', 'день', 'рука', 'раз', 'работа', 'слово', 'место', 'лицо',
...
def play(word):
    ...
    print(f'Ваше слово: {word_completion}')


    while True:
        ch = input('Введите букву или слово: ').upper()
        if not ch.isalpha():
            print('Введите символ русского алфавита!')
            continue
        elif ch in guessed_letters or ch in guessed_words:
